...
int bc_printbigchar(BIGCHAR chindex, int x, int y, COLORS color, COLORS color1); // vivod big simbol
...
int bc_bigcharread(int fd, int * big, int need_count, int* count); // read big char from file
